...
public class BadHabbitsCaffeineCepTest extends BaseCepTest {
	...
	protected void runPseudoClockExample(KieSession ksession) {
        ...
        for (int index = 0; index < 5; index++) {
        	RaisedCaffeineLevelEvent caff = new RaisedCaffeineLevelEvent();
            ksession.insert(caff);
        ...
        Collection<?> newEvents = ksession.getObjects(new ClassObjectFilter(CaffeineBeforeSleepEvent.class));
