...
import sbnz.mrsandman.neuralinkapp.model.events.caffeine.RaiseCaffeineLevelEvent;
...
public class RaisedCaffeineLevelCepTest extends BaseCepTest {
	...
	protected void runPseudoClockExample(KieSession ksession) {
		...
		Collection<?> newEvents = ksession.getObjects(new ClassObjectFilter(RaiseCaffeineLevelEvent.class));
